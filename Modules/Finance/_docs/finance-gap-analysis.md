...
**5. Partial Payments & Payment Allocation**
...
**7. Withholding Tax Certificates & GRA Compliance**
...
**9. Automated Depreciation Scheduling**
...
**11. Automated Bank Statement Import & Auto-Reconciliation**
...
**13. Financial Ratios & Advanced Dashboard**
...
**20. Audit Trail on Financial Records**
...
**23. Notes & Comments on Financial Records**
...
| Credit Notes / Debit Notes | 0% | 100% | **Critical** |
| Customer Management | 10% | 100% | **Critical** |
| Partial Payments & Allocation | 20% | 100% | **Critical** |
| Budget Management | 0% | 100% | **Critical** |
| Expense Claims | 0% | 100% | **Critical** |
| Petty Cash | 0% | 100% | **Critical** |
| WHT Certificates & GRA Reports | 10% | 100% | Large |
| Multi-Currency | 5% | 100% | Large |
| Bank Reconciliation (auto-match) | 30% | 100% | Large |
| Tax Return Reports (VAT/NHIL) | 5% | 100% | Large |
| Fixed Asset Depreciation (auto-schedule) | 60% | 100% | Medium |
| Financial Ratios & Dashboard | 25% | 100% | Large |
| Customer Statements | 0% | 100% | Large |
| Cheque Management | 10% | 100% | Medium |
| Segment / Cost Centre Reporting | 20% | 100% | Medium |
| Consolidated Multi-Company Reports | 0% | 100% | Medium |
| Audit Trail on GL | 20% | 100% | Medium |
| Document Attachments (Invoices) | 0% | 100% | Medium |
| Payment Batch Processing | 0% | 100% | Medium |
| Invoice Reminders (automated) | 20% | 100% | Medium |
...
### Phase 1 — Operational must-haves (unblock daily finance work)
1. **Credit Notes & Debit Notes** — Critical for AR/AP corrections
2. **Partial Payments & Payment Allocation** — Most businesses pay invoices partially
3. **Customer Management** — Replace free-text `customer_name` with proper Customer model
4. **Expense Claims** — Staff expense reimbursement (via staff portal)
5. **Petty Cash Management** — Required for field operations (Farms, Construction, Fleet)

### Phase 2 — Compliance & controls
1. Budget Management (creation + budget vs. actual report)
2. WHT Certificates + VAT Return Report (GRA compliance)
3. Automated Depreciation Scheduling (artisan command)
4. Bank Statement Import + Auto-Reconciliation
5. Audit Trail on Journal Entries

### Phase 3 — Reporting depth & automation
1. Financial Ratios Dashboard (DSO, DPO, current ratio, working capital)
2. Customer & Vendor Statements (bulk send)
3. Segment / Cost Centre P&L Reports
4. Payment Batch Processing
5. Automated Invoice Reminders (configurable rules)

### Phase 4 — Enterprise & compliance
1. Multi-Currency (exchange rates, FX gain/loss)
2. Cheque Management
3. Consolidated Group Reporting
4. IFRS 16 Lease Accounting
5. GRA e-Invoice / EFRIS Integration
