...
class CommunicationCentreServiceProvider extends ServiceProvider
{
    use PathNamespace;

    protected string $name = 'CommunicationCentre';

    protected string $nameLower = 'communicationcentre';
