...
// v4 FIX: Schema replaces Form as the method signature type for page-level forms
...
trait HasEditRecordModal
{
    ...
    public function recordClicked(int|string $recordId, array $data): void
    {
        ...
        // Rebuild the form schema now that we know the record ID
        $this->form($this->form);
    ...
    // v4 FIX: signature changed from form(Form $form): Form → form(Schema $schema): Schema
